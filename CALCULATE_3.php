...
<article>
	<div id="_snb">
		<ul class="con_width">
			...
			<li class="_ov">
                <a href="CALCULATE_3.php"><span><em>지급관리</em></span></a>
                <ul>
	...
	<div class="sub_wrap">
        <img src="images/PAY0001.png">
		<p>
            <span>▶ 지급금 관리 화면</span> : 발생된 매입자료에 대한 거래처별 지급금 관리 내역 등록 시에 사용(출력조회는 <span class="under">현황->미지급 현황</span> 메뉴에서 사용)
        </p>
        <img src="images/PAY0002.png">
		<p>
            <span>▶ 지급금 관리 화면(외화)</span> : 발생된 매입자료에 대한 거래처별 지급금 관리 내역 등록 시에 사용(출력조회는 <span class="under">현황->미지급 현황</span> 메뉴에서 사용)
        </p>
	</div>
</article>
