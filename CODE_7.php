...
<article>
	<div id="_snb">
		<ul class="con_width">
			...
			<li class="_ov">
                <a href="CODE_7.php"><span><em>선박코드</em></span></a>
                <ul>
	...
	<div class="sub_wrap">
		<img src="images/code_10.png">
		<p>
            <span>▶ 추가</span> : 새로운 선박코드를 등록할 수 있다.(코드는 사용자임의 지정)<br><br>
            <span>▶ 삭제</span> : 등록된 선박코드를 삭제할 수 있다.<br><br>
            <span>▶ 수정</span> : 등록된 선박코드를 수정할 수 있다.
        </p>
	</div>
</article>
