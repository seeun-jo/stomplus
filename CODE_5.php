...
<div class="svis svis_bg1">
	<div class="con_width">
	    ...
	    <span class="txt">코드관리_매출처코드</span>  
    </div>
<article>
	<div id="_snb">
		<ul class="con_width">
			...
			<li class="_ov">
                <a href="CODE_5.php"><span><em>매출처코드</em></span></a>
                <ul>
	...
	<div class="sub_wrap">
		<img src="images/code_8.png">
		<p>
            <span>▶ 추가</span> : 새로운 매출처를 등록할 수 있다.(코드는 사용자임의 지정)<br><br>
            <span>▶ 삭제</span> : 등록된 매출처를 삭제할 수 있다.<br><br>
            <span>▶ 수정</span> : 등록된 매출처를 수정할 수 있다.
        </p>
	</div>
</article>
