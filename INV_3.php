...
<article>
	<div id="_snb">
		<ul class="con_width">
			...
			<li class="_ov">
				<a href="INV_3.php"><span><em>매출관리</em></span></a>
				<ul>
	...
	<div class="sub_wrap">
		<img src="images/inv_1.png" width="100%;">
		<p>
			<span>▶ 매출 관리 화면</span> : 견적서 관리에서 설명 된 기능 및 업무 흐름의 내용들과 대부분 중복되므로 매출 관리에 대한 설명은 생략 함
		</p>
