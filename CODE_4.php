...
<div class="svis svis_bg1">
	<div class="con_width">
	    ...
	    <span class="txt">코드관리_매입처별 품목단가</span>  
    </div>
<article>
	<div id="_snb">
		<ul class="con_width">
			...
			<li class="_ov">
                <a href="CODE_4.php"><span><em>매입처별 품목단가</em></span></a>
                <ul>
	...
	<div class="sub_wrap">
		<img src="images/code_7.png" width="100%;">
		<p>
            ▶ 해당 품목에 대한 매입처별 매입단가들을 관리하여 조회 및 참조 시에 사용 (<span class="button">매입 품목단가 참조 시</span>)
        </p>
	</div>
</article>
